...
$formName = "AD Account - Copy groupmemberships"
$formGuid = ""
...
$delegatedFormName = "AD Account - Copy groupmemberships"
$delegatedFormGuid = ""
...
$taskActionName = "AD-user-set-groupmemberships"
$taskActionGuid = ""
...
'@;
            ...
            variables = @(@{name = "groupsToAdd"; value = "{{form.memberships.leftToRight.toJsonString}}"; typeConstraint = "string"; secret = "False"},
                        @{name = "userPrincipalName"; value = "{{form.gridUsersTarget.UserPrincipalName}}"; typeConstraint = "string"; secret = "False"});
        }
        $body = $body | ConvertTo-Json
